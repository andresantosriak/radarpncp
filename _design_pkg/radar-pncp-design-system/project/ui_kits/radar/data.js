...
window.RADAR.editais = [
  {
    ...
    publicado: '02/06/2026', prazo: '14/06/2026',
    valor: 'R$ 62.000', valorNum: 62000,
    score: 87, status: 'forte', urgente: true,
    ...
    custoTotal: 'R$ 22.000', margem: '35%',
    propostaMin: 'R$ 41.000', propostaIdeal: 'R$ 48.000 – 54.000',
    risco: 'Baixo', concorrencia: 'Média', burocracia: 'Baixa', chance: 'Alta',
  },
  {
    id: 'op-377',
    ...
    publicado: '30/05/2026', prazo: '21/06/2026',
    valor: 'R$ 178.000', valorNum: 178000,
    score: 79, status: 'boa', urgente: false,
    ...
    custoTotal: 'R$ 96.000', margem: '30%',
    propostaMin: 'R$ 132.000', propostaIdeal: 'R$ 150.000 – 165.000',
    risco: 'Médio', concorrencia: 'Alta', burocracia: 'Média', chance: 'Média',
  },
  {
    id: 'op-355',
    ...
    modalidade: 'Dispensa eletrônica',
    publicado: '01/06/2026', prazo: '11/06/2026',
    valor: 'R$ 38.500', valorNum: 38500,
    score: 72, status: 'boa', urgente: true,
    ...
    custoTotal: 'R$ 24.400', margem: '28%',
    propostaMin: 'R$ 31.000', propostaIdeal: 'R$ 34.000 – 37.000',
    risco: 'Médio', concorrencia: 'Baixa', burocracia: 'Baixa', chance: 'Alta',
  },
  {
    id: 'op-341',
    ...
    modalidade: 'Pregão eletrônico',
    publicado: '28/05/2026', prazo: '25/06/2026',
    valor: 'R$ 96.000', valorNum: 96000,
    score: 64, status: 'possivel', urgente: false,
    ...
    custoTotal: 'R$ 62.000', margem: '22%',
    propostaMin: 'R$ 80.000', propostaIdeal: 'R$ 86.000 – 92.000',
    risco: 'Alto', concorrencia: 'Média', burocracia: 'Alta', chance: 'Baixa',
  },
  {
    id: 'op-329',
    ...
    modalidade: 'Pregão eletrônico',
    publicado: '29/05/2026', prazo: '19/06/2026',
    valor: 'R$ 240.000', valorNum: 240000,
    score: 12, status: 'baixa', urgente: false,
    ...
    documentos: [],
    custos: [],
    custoTotal: '—', margem: '—', propostaMin: '—', propostaIdeal: '—',
    risco: 'Alto', concorrencia: 'Alta', burocracia: 'Alta', chance: 'Baixa',
  },
];
